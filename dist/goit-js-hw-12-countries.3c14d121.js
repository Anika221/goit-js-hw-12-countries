...
function countryCardTpl(country) {
    ...
    <div class="country-card">
      <h2>${country.name}</h2>
      <img src="${country.flag}" alt="\u{41F}\u{440}\u{430}\u{43F}\u{43E}\u{440} ${country.name}" width="200">
      <p><b>\u{421}\u{442}\u{43E}\u{43B}\u{438}\u{446}\u{44F}:</b> ${country.capital}</p>
      <p><b>\u{41D}\u{430}\u{441}\u{435}\u{43B}\u{435}\u{43D}\u{43D}\u{44F}:</b> ${country.population}</p>
      <p><b>\u{41C}\u{43E}\u{432}\u{438}:</b> ${country.languages.map((l)=>l.name).join(', ')}</p>
    </div>
  `;
}
...
function onSearch(e) {
    ...
    (0, _fetchCountriesDefault.default)(query).then((countries)=>{
        ...
        if (countries.length > 10) {
            (0, _core.info)({
                text: "\u0417\u0430\u043D\u0430\u0434\u0442\u043E \u0431\u0430\u0433\u0430\u0442\u043E \u0437\u0431\u0456\u0433\u0456\u0432. \u0423\u0442\u043E\u0447\u043D\u0456\u0442\u044C \u043F\u043E\u0448\u0443\u043A!"
            });
            return;
        }
        ...
        if (countries.length === 1) refs.container.innerHTML = countryCardTpl(countries[0]);
    }).catch(()=>{
        (0, _core.error)({
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}],"irvaP":[function(require,module,exports,__globalThis) {
/**
